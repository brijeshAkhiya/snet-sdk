import MPEAbi from 'singularitynet-platform-contracts/abi/MultiPartyEscrow.json' assert { type: 'json' };
import MPENetworks from 'singularitynet-platform-contracts/networks/MultiPartyEscrow.json' assert { type: 'json' };
...
class MPEContract {
  ...
  async getPastOpenChannels(account, service, startingBlockNumber) {
    ...
    return loadash.map(channelsOpened, (channelOpenEvent) => {
